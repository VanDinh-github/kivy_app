...
class BuildCheckApp(MDApp):
    def __init__(self, **kwargs):
        ...
        self.dialog=None
        self.pc_config=None
        self.cpu_data=self.load_component('./datas/cpu.json')
        
        self.gpu_data=self.load_component('./datas/gpu.json')
        self.ram_data=self.load_component('./datas/ram.json')
        self.mainboard_data=self.load_component('./datas/mainboard.json')
        self.psu_data=self.load_component('./datas/psu.json')
        self.os_data=self.load_component('./datas/os.json')
        ...
        self.game_data = self.load_component('./datas/steam_games_cache.json')
        self.game_menu = None
    ...
    def build(self):
        Builder.load_file('gui/home_screen.kv')
        Builder.load_file('gui/pc_input_screen.kv')
        Builder.load_file('gui/select_game_screen.kv')
        Builder.load_file('gui/compatibilitY_screen.kv')
        Builder.load_file('gui/details_screen.kv')
